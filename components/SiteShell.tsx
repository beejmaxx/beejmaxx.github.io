...
const navigation = [
  ...
  { label: "blog", href: "/blog", current: "blog" },
  ...
  return (
    <div className={styles.site}>
      ...
      <footer className={styles.footer}>
        <p>built by bijan.</p>
        <nav aria-label="Footer navigation"><a href="/sitemap">sitemap</a><a href="mailto:beejmaxx@gmail.com">email</a><a href="https://github.com/beejmaxx">github</a><a href="#top">top</a></nav>
      </footer>
    </div>
  );
}
